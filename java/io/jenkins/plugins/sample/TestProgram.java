...
public class TestProgram{
    ...
    private final static String defects4jDir = "/home/tanner/School/616/defects4j";
    private final static String defects4jExecutable = defects4jDir + "/framework/bin/defects4j";
    private final static String srcCodeBaseDir = "/tmp/";
	...
	try {
	    String[] cmd = new String[]{defects4jExecutable, "checkout", "-p", ID, "-v", 
				bugID + "b", "-w", codeDirectory};
	    runCommand(cmd);
	} catch (Exception e) {
	    return "";
	}
	...
	try {
	    String[] cmd = new String[]{defects4jExecutable, "info", "-p", ID, "-b", Integer.toString(index)};
